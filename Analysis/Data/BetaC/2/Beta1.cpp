...
int main() {
    ...
    std::filesystem::current_path("C:\\Supaero\\Stage\\Codigo3\\Analysis\\Data\\BetaC\\2");
    ...
    // varredura macro: beta de 0.00 → 0.09 em passos de 0.01,
    // mas nomeando arquivos como Beta1, Beta2, ...
    int beta_idx = 1;
    for (beta_val = 0.00f; beta_val <= 0.09f + 1e-6f; beta_val += 0.01f, ++beta_idx) {
