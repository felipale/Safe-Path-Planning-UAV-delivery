...
int main() {
    ...
    float beta_val  = 0.002f;         // β fixo em 0.002
    ...
    std::filesystem::current_path(
      "C:\\Supaero\\Stage\\Codigo3\\Analysis\\Data\\Delta\\2"
    );
    ...
    // ── varredura de δ: 0.1 ≤ δ ≤ 0.9 em passos de 0.05 ───────────────────
    int delta_idx = 1;
    for (delta_val = 0.1f;
         delta_val <= 0.9f + 1e-6f;
         delta_val += 0.05f, ++delta_idx)
    {
