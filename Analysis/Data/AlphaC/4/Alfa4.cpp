...
int main() {
    ...
    const std::filesystem::path base_output =
        "C:\\Supaero\\Stage\\Codigo3\\Analysis\\Data\\AlphaC\\4";
    ...
    std::vector<float> deltas = {0.00006f,0.000065f,0.00007f,0.000075f, 0.00008f,0.000085f, 0.00009f};
    ...
    // ── varre δ mantendo α = 0.0035 e β=1e-4, salvando tudo em base_output ────────────
