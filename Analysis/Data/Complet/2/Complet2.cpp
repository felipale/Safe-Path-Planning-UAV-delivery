...
int main() {
    ...
    const std::filesystem::path base_output =
        "C:\\Supaero\\Stage\\Codigo3\\Analysis\\Data\\Complet\\2";
    ...
    std::vector<float> alphas = {
        0.0030f, 0.0035f, 0.0040f, 0.0045f,
        0.0050f, 0.0055f, 0.0060f
    };
    std::vector<float> deltas = {
        0.0045f, 0.0050f, 0.0055f, 0.0060f,
        0.0065f, 0.0070f, 0.0075f
    };
