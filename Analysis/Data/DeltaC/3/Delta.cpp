...
int main() {
    ...
    const int trials                 = 10; // Aumentou para de 10
    ...
    std::filesystem::current_path(
      "C:\\Supaero\\Stage\\Codigo3\\Analysis\\Data\\DeltaC\\3"
    );
    ...
    // ── varredura de δ: 0.0 ≤ δ ≤ 0.01 em passos de 0.001 ───────────────────
    int delta_idx = 1;
    for (delta_val = 0.00f;
         delta_val <= 0.01f + 1e-6f;
         delta_val += 0.001f, ++delta_idx)
    {
